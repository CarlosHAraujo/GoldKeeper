        ...
        public static IEnumerable<object[]> GetPostExpenseSample()
        {
            yield return new object[]
            {
                new PostExpenseModel
                {
                    ...
                    Discount = 0,
                    ExtraCosts = new List<ExtraCostModel>() { new ExtraCostModel { CostId = 1, Value = 0 } },
            ...
            yield return new object[]
            {
                new PostExpenseModel
                {
                    ...
                    Date = DateTime.Now,
                    Discount = -1,
                    ExtraCosts = new List<ExtraCostModel>() { new ExtraCostModel { CostId = -1, Value = -1 } },
            ...
            yield return new object[]
            {
                new PostExpenseModel
                {
                    ...
                    ExtraCosts = new List<ExtraCostModel>() { new ExtraCostModel { CostId = int.MaxValue, Value = decimal.MaxValue } },
            ...
            yield return new object[]
            {
                new PostExpenseModel
                {
                    ...
                    ExtraCosts = new List<ExtraCostModel>() { new ExtraCostModel { CostId = int.MinValue, Value = decimal.MinValue } },
